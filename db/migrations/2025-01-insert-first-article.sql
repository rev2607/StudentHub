-- Insert the first article: JEE Main 2026 Preparation Guide
-- Run this AFTER creating the articles table with 2025-01-create-articles.sql
...
SELECT id, title, slug, author, category, is_published, published_at 
FROM articles 
WHERE slug = 'jee-main-2026-preparation-guide-smart-strategies-for-top-ranks';
