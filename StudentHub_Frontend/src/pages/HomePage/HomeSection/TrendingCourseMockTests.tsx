    ...
    <section className="bg-white-100 p-6 text-gray-800">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-2xl font-bold text-gray-800 pb-4">Trending Courses And Mock Tests</h1>
          <p className="text-black font-light">
            Enhance and update your skills to
            <span className="font-semibold"> boost </span>
            your career path with <br /> popular courses and mock test
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div>
              <h2 className="text-xl font-bold text-right text-gray-800 mb-4">Trending Mock Tests</h2>
              <div className="flex">
...
export default TrendingCourseMockTests;
