...
const Recommendations = () => {
  ...
  return (
    <section className="bg-[#f9fbfc] py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#15314b] mb-6 sm:mb-10">Recommended Comparisons</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          {recommendedColleges.map((item) => (
            <div
              key={item.id}
              className="border border-[#d6e7db] rounded-xl bg-white p-4 sm:p-8 flex flex-col items-center shadow-sm hover:shadow-md transition-shadow duration-200"
            >
              <div className="flex items-center justify-center gap-6 sm:gap-10 mb-6 sm:mb-8">
                <img
                  ...
                  width="56"
                />
                <span className="text-xl sm:text-2xl font-bold text-[#15314b]">VS</span>
                <img
                  alt="College logo"
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover border border-gray-200"
                  height="56"
              ...
              <div className="flex w-full justify-between items-center mb-6 sm:mb-8 text-sm sm:text-base">
                <div className="text-left">
                  <p className="font-semibold text-[#15314b] leading-tight">{item.name1}</p>
                  <p className="text-gray-500 text-xs sm:text-sm mt-1">NIRF Rank: {item.rank1}</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-[#15314b] leading-tight">{item.name2}</p>
                  <p className="text-gray-500 text-xs sm:text-sm mt-1">NIRF Rank: {item.rank2}</p>
                </div>
              </div>
              <button
