...
export default function KHLUPage() {
    ...
    switch (activeTab) {
        ...
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026</h2>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-600">KHLU (Karnataka Health and Life Sciences University)</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-medium text-gray-700">Conducting Authority:</span>
                        <span className="text-gray-600">Karnataka Health and Life Sciences University</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-medium text-gray-700">Exam Level:</span>
                        <span className="text-gray-600">State Level Medical Entrance</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-600">English and Kannada</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-600">180 questions</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="font-medium text-gray-700">Total Marks:</span>
                        <span className="text-gray-600">720 marks</span>
                      </div>
                      <div className="flex justify-between">
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold text-gray-800 mb-4">About KHLU</h3>
                <div className="p-4">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    KHLU (Karnataka Health and Life Sciences University) entrance examination is conducted for admission to undergraduate medical programs in Karnataka state. The exam tests candidates' knowledge in Physics, Chemistry, and Biology at the 10+2 level.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    KHLU provides admission opportunities to various medical and allied health science programs across Karnataka state universities and colleges.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4">
                    <h4 className="text-lg font-semibold text-gray-800 mb-3">Participating Colleges</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>• Government Medical Colleges, Karnataka</li>
                      <li>• Private Medical Colleges, Karnataka</li>
                      <li>• Dental Colleges, Karnataka</li>
                      <li>• Allied Health Sciences Colleges</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="font-medium text-gray-700">Popular Programs:</span>
                        <span className="text-gray-600">MBBS, BDS</span>
                      </div>
                      <div className="flex justify-between">
      ...
      case 'dates':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Important Dates</h2>
      ...
      case 'eligibility':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Eligibility Criteria</h2>
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start">
                      <div className="w-2 h-2 bg-gray-500 rounded-full mt-2 mr-3"></div>
                      <div>
                        <p className="text-gray-700 font-medium">Domicile</p>
                        <p className="text-gray-600 text-sm">Karnataka domicile required</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      case 'application':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Application Process</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Register on official KHLU portal with valid email and mobile number</p>
                    </div>
                  </div>
      ...
      case 'pattern':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Exam Pattern</h2>
                ...
                <div className="space-y-4">
                  <div className="pl-4">
                    ...
                    <div className="text-gray-700 mt-2">
                      <p>Computer-Based Test (CBT) with 180 multiple choice questions</p>
                    </div>
                  </div>
                  ...
                  <div className="pl-4">
                    ...
                    <div className="text-gray-700 mt-2">
                      <p>Physics (45), Chemistry (45), Biology (90)</p>
                    </div>
                  </div>
      ...
      case 'syllabus':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Syllabus</h2>
      ...
      case 'cutoff':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Cutoff Trends</h2>
      ...
      case 'counselling':
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026 Counselling Process</h2>
              ...
              <div className="p-4">
                <div className="space-y-4">
                  <div className="pl-4">
                    ...
                    <div className="text-gray-700 mt-2">
                      <p>Karnataka Health and Life Sciences University conducts centralized counselling</p>
                    </div>
                  </div>
      ...
      default:
        return (
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">KHLU 2026</h2>
              <p className="text-gray-600">Select a tab to view detailed information about KHLU 2026.</p>
            </div>
          </div>
        );
    }
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-gray-800 font-medium">KHLU</span>
          </nav>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                <span className="text-blue-600 font-bold text-lg">KL</span>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-gray-800 mb-2">
                  KHLU 2026: Exam Dates, Pattern, Syllabus, Previous Year Papers, Cutoff and Latest Changes
                </h1>
                <div className="flex items-center space-x-4">
                  <span className="text-blue-600 font-medium">#KHLU</span>
                  <span className="text-gray-600 text-sm">Karnataka Health and Life Sciences University</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex items-center space-x-3 mb-2">
                      <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                        <span className="text-blue-600 font-bold text-sm">KL</span>
                      </div>
                      <div>
                        <div className="font-semibold text-gray-800">KHLU B.Tech</div>
                        <div className="text-sm text-gray-600">Karnataka Health and Life Sciences University</div>
                      </div>
                    </div>
                    <div className="text-sm text-gray-600 mb-2">
                      Top Health Sciences Institute | 1000+ Seats | KHLU Based | State University
                    </div>
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div>
                        <div className="font-semibold text-gray-800">KHLU B.Pharmacy</div>
                        <div className="text-sm text-gray-600">Karnataka Health and Life Sciences University</div>
                      </div>
                    </div>
                    <div className="text-sm text-gray-600 mb-2">
                      Top Pharmacy Institute | 500+ Seats | KHLU Based | State University
                    </div>
                    <button className="w-full bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition-colors text-sm font-medium">
                      ✓ Apply Now
                    </button>
