    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-700 mb-6">
          IIT Madras offers an expansive mix of undergraduate, postgraduate, and doctoral pathways that encourage interdisciplinary learning, entrepreneurial problem-solving, and collaboration with industry and global partners.
        </p>
