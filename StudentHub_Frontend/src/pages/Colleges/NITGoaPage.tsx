        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          <div className="flex items-start gap-6 mb-6">
            <div className="w-32 h-32 rounded-lg flex items-center justify-center bg-gray-100 border border-gray-200">
              <div className="w-full h-full flex items-center justify-center text-gray-400 text-xs font-medium">NIT<br/>Goa</div>
            </div>
            <div>
              <h1 className="text-2xl font-semibold text-gray-900 mb-4">National Institute of Technology Goa</h1>
              <div className="flex items-center gap-4 text-sm text-gray-600">
                <div className="flex items-center"><MapPin className="w-4 h-4 mr-1" />Ponda, Goa</div>
