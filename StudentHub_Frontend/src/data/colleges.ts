...
export const colleges: College[] = [
  ...
  createCollege({ id: "clg-14a", slug: "vit-chennai", name: "VIT Chennai", state: "Tamil Nadu", location: "Chennai, Tamil Nadu", nirfRank: 11, establishmentYear: 2010, logoUrl: "/src/assets/vit_logo.png" }),
  createCollege({ id: "clg-14b", slug: "vit-bhopal", name: "VIT Bhopal", state: "Madhya Pradesh", location: "Bhopal, Madhya Pradesh", nirfRank: 11, establishmentYear: 2017, logoUrl: "/src/assets/vit_logo.png" }),
  createCollege({ id: "clg-14c", slug: "vit-amaravati", name: "VIT Amaravati (VIT-AP)", state: "Andhra Pradesh", location: "Amaravati, Andhra Pradesh", nirfRank: 11, establishmentYear: 2017, logoUrl: "/src/assets/vit_logo.png" }),
  createCollege({ id: "clg-14d", slug: "vit-bangalore", name: "VIT Bangalore", state: "Karnataka", location: "Bangalore, Karnataka", nirfRank: 11, establishmentYear: 2024, logoUrl: "/src/assets/vit_logo.png" }),
