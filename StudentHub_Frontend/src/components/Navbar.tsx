...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { title: "Career Test", path: "/psychometric-test" },
  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex justify-between items-center h-16 sm:h-18 lg:h-20 gap-2">
          {/* Logo Section */}
          ...
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center space-x-0.5 xl:space-x-1 flex-nowrap flex-shrink-0">
            {menuItems.map((item) => {
              ...
              return (
                <Link 
                  key={item.title} 
                  to={item.path} 
                  className={`relative px-2 py-2 xl:px-3 text-xs xl:text-sm font-medium transition-all duration-200 rounded-md whitespace-nowrap ${
                    isActive 
