...
def get_supabase_client():
    ...
    if not SUPABASE_URL or not SUPABASE_SERVICE_ROLE_KEY:
        print("[WARNING] Supabase not configured. News caching will be disabled.")
    ...
    if "your_supabase_url_here" in SUPABASE_URL or "your_supabase_service_role_key_here" in SUPABASE_SERVICE_ROLE_KEY:
        print("[WARNING] Supabase credentials are placeholder values. News caching will be disabled.")
