...
insert into public.questions (
      ...
      'Mathematics', 'General', 'single', 'Let , , and be the coefficients of x 7 , x 5 , x 3 and x respectively in the expansion of , x > A. If u and v satisfy the equations u + v = 18, u + v = 20, then u + v equals :',
      4, -1, 1
    );
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'For a 3 × 3 matrix M, let trace (M) denote the sum of all the diagonal el ements of M. Let A be a 3 × 3 matrix such that |A| = and trace A. = C. If B = adj (adj(2A)), then the val ue of|B| + traceB. equals:',
      4, -1, 3
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Let a line pass through two distinct points P( 2, 1, C. and Q, and be par allel to the vector . If the distance of the poi nt Q from the pointR(1, 3, C. is 5, then the square of the area of PQR is equal to:',
      4, -1, 5
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The perpendicular distance, of the line from the point P(2, 10,A. , is:',
      4, -1, 7
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Let A = {1, 2, 3, 4} and B = {1, 4, 9, 16}. Then t he number of many-one functions f : A B such that 1 fA. is equal to :',
      4, -1, 9
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Let E : = 1, a > b and H : = A. Let the distance between the foci of E and the foci of H be . If a A = 2, and the ratio of the eccentricities of E and H is , then the sum of the lengths of their latus rectums is equal to :',
      4, -1, 12
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'A symmetric thin biconvex lens is cut into four equal parts by two planes AB and CD as shown in figure. If the power of original lens is 4D then the power of a part of the divided l ens is',
      4, -1, 13
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The maximum percentage er ror in the measurment of density of a wire is [Given, mass of wire = (0.60 ± 0.003)g radius of wire = (0.50 ± 0.01)cm length of wire (10.00 ± 0.05)cm]',
      4, -1, 14
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'For a short dipole placed at origin O, the dipole moment P is along x-axis, as shown in the figure. If the electric potential and electric field at A are V 0 and E 0 , respectively, then the correct com bination of the electric potential and electric field, respectively, at point B on the y-axis is given by',
      4, -1, 15
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Whi ch one of the following is the correct dimensional formula for the capacitance in F ? M, L, T and C stand for unit of mass, length, time and charge,',
      4, -1, 16
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'For a diatomic gas, if for rigid molecules and for another diatomic molecules, but also having vibrational modes. Then, which one of the following options is cor rect ? ( Cp and Cv are specific heats of the gas at constant pressure and volume)',
      4, -1, 17
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'A light source of wavelength illuminates a met al sur face and electrons ar e ej ected with maximum kinetic energy of 2 eV. If the same surface is illuminated by a light source of wavelength , then the maximumkinetic energy ofejected electrons willbe(Theworkfunctionofmetal is1 eV)',
      4, -1, 18
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'A ball of mass 100 g is projected with velocity 20 m/s at 60° with horizontal. The decrease in kinetic ener gy of the ball during the motion from point of projection to highest point is :',
      4, -1, 19
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The tube of length L is shown in the figure. The radius of cross section at the point',
      4, -1, 21
    );
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'A', '2 m/s', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'B', '4 m/s', false);
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Arrange the following compounds in increasing order of their dipole moment : HBr, H 2 S, NF 3 and CHCl 3',
      4, -1, 22
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Identify the number of structure/s from the following which can be correlated to D-glyceraldehyde.',
      4, -1, 23
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The maximu m coval ency of a non-met al lic group 15 element ''E'' with weakest E E bond is :',
      4, -1, 24
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The species whichdoes not under go disproportionation reaction is :',
      4, -1, 25
    );
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'A', '-(III),', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'B', '-(IV ),', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'C', '-(II),', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'D', '-(I)', true);
-- Q26 (Mathematics)
insert into public.questions (
      id, paper_id, subject, topic, type, question_text, positive_mark, negative_mark, order_index
    ) values (
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The maxi mu m nu mber of RBr produci ng 2-met h ylbutane by above sequence of reactions is _____. (Consider the structural isomer s only)',
      4, -1, 26
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Match List-I with List- II . List - I (Partial Derivatives) List - II (Thermodynamic Quantity) A. (I) C P B. (II) S C. (III) C V D. (IV ) V Choose the correct answer from the options given bel ow :',
      4, -1, 27
    );
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'A', '-(II),', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'B', '-(III),', true);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'C', '-(I),', false);
insert into public.choices (id, question_id, label, text, is_correct)
values (gen_random_uuid(), gen_random_uuid(), 'D', '-(IV)', false);
-- Q28 (Mathematics)
insert into public.questions (
      id, paper_id, subject, topic, type, question_text, positive_mark, negative_mark, order_index
    ) values (
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The correct order of the following complexes in ter ms of their cr ystal field stabilizat ion energies is :',
      4, -1, 28
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Given below are two statements : Stat ement (I) : A spectral line will be observed f or a 2p x 2p y t ransition. Stat ement (II) : 2p x and 2p y ar e degenerate orbitals. In the light of the above statement s, choose the correct answer from the options given below :',
      4, -1, 30
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'Given bel ow are two statement : Stat ement (I) : Nitrogen, sulphur, halogen and phosphorus present in an organi c compound are Stat ement (II) : The element s present in the compound ar e converted from covalent form into ionic form by fusing the compound with In the light of the above statement s, choose the correct answer from the options given below :',
      4, -1, 31
    );
insert into public.choices (id, question_id, label, text, is_correct)
...
insert into public.questions (
      ...
      gen_random_uuid(),
      (select id from public.papers where exam='JEE Mains' and year=2025 and title='JEE Main 2025 Jan 22 Shift 2 — MPC' order by created_at desc limit 1),
      'Mathematics', 'General', 'single', 'The al kane from bel ow having two secondar y hydrogens is :',
      4, -1, 33
    );
insert into public.choices (id, question_id, label, text, is_correct)
